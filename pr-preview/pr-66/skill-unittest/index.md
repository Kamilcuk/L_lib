...
- **Assertions Reference**: See [references/assertions.md](https://Kamilcuk.github.io/L_lib/pr-preview/pr-66/skill-unittest/references/assertions.md) for a full list of `L_unittest_*` functions.
- **Common Patterns**: See [references/patterns.sh](https://Kamilcuk.github.io/L_lib/pr-preview/pr-66/skill-unittest/references/patterns.sh) for examples of common test scenarios.
