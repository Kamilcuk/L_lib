...
- **Assertions Reference**: See [references/assertions.md](https://kamilcuk.github.io/L_lib/skill-unittest/references/assertions.md) for a full list of `L_unittest_*` functions.
- **Common Patterns**: See [references/patterns.sh](https://kamilcuk.github.io/L_lib/skill-unittest/references/patterns.sh) for examples of common test scenarios.
