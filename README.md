...
```bash
mkdir -vp ~/.local/bin/
wget -O ~/.local/bin/L_lib.sh https://github.com/Kamilcuk/L_lib/releases/download/v2.0.0/L_lib.sh
...
```bash
bash <(wget -qO- https://github.com/Kamilcuk/L_lib/releases/download/v2.0.0/L_lib.sh) L_setx L_log 'Hello world'
```
